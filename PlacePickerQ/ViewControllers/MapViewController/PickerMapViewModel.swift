...
protocol PickerMapViewModelDelegate: class {
...
class PickerMapViewModel: NSObject {
...
//        gmsAutocompleteViewController?.delegate = main as? GMSAutocompleteViewControllerDelegate
    }
